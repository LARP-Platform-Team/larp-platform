...
<html>
	...
	<body>
		<a href="#create-letter" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-letter" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:letterInstance, action:'save']" >
				<fieldset class="form">
